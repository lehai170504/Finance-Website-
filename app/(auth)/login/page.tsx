    ...
    <div className="flex flex-col w-full max-w-sm mx-auto font-sans animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex flex-col items-center space-y-6 text-center mb-10">
        ...
        <div className="space-y-2 relative">
          <div className="flex items-center justify-center gap-2 text-primary mb-1">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.3em]">Hệ thống bảo mật</span>
          </div>
          ...
          <p className="text-muted-foreground font-medium text-sm tracking-tight">
            Nhập thông tin để quản lý dòng tiền ngay
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="space-y-2.5">
          <label className="text-[10px] font-black uppercase tracking-[0.2em] text-foreground/70 ml-1 flex items-center gap-2">
            <Mail size={12} className="text-primary" /> Email định danh
          </label>
        ...
        <Button
          ...
          variant="default"
          size="lg"
          className="w-full h-16 rounded-2xl font-black uppercase tracking-[0.2em] text-sm shadow-2xl shadow-primary/30 active:scale-[0.98] transition-all"
        >
      ...
      <div className="relative my-10">
        ...
        <div className="relative flex justify-center">
          <span className="bg-background px-4 text-[9px] uppercase font-black tracking-[0.3em] text-muted-foreground/60">
            Social Connect
          </span>
        </div>
      </div>

      <div className="flex justify-center w-full transform hover:scale-[1.02] transition-transform duration-300">
        <GoogleLogin
